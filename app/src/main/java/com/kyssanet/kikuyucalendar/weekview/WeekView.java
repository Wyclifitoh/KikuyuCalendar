package com.kyssanet.kikuyucalendar.weekview;

import static android.content.ContentValues.TAG;
import static com.kyssanet.kikuyucalendar.weekview.WeekViewUtil.isSameDay;
import static com.kyssanet.kikuyucalendar.weekview.WeekViewUtil.today;
...
import com.kyssanet.kikuyucalendar.MainActivity;
import com.kyssanet.kikuyucalendar.R;
...
//                }
    ...
    private void drawTimeColumnAndAxes(Canvas canvas) {
        ...
        for (int i = 0; i < 24; i++) {
            ...
            if (time == null)
                throw new IllegalStateException("A DateTimeInterpreter must not return null time");
            if (top < getHeight())
                if (time.equals("12 AM") || time.equals("12AM")) {
                    canvas.drawText("12", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("1 AM") || time.equals("1AM")) {
                    canvas.drawText("1", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("2 AM")  || time.equals("2AM")) {
                    canvas.drawText("2", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("3 AM") || time.equals("3AM")) {
                    canvas.drawText("3", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("4 AM") || time.equals("4AM")) {
                    canvas.drawText("4", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("5 AM") || time.equals("5AM")) {
                    canvas.drawText("5", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("6 AM") || time.equals("6AM")) {
                    canvas.drawText("6", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("7 AM") || time.equals("7AM")) {
                    canvas.drawText("7", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("8 AM") || time.equals("8AM")) {
                    canvas.drawText("8", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("9 AM") || time.equals("9AM")) {
                    canvas.drawText("9", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("10 AM") || time.equals("10AM")) {
                    canvas.drawText("10", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("11 AM") || time.equals("11AM")) {
                    canvas.drawText("11", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("0 PM") || time.equals("0PM")) {
                    canvas.drawText("0", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("1 PM") || time.equals("1PM")) {
                    canvas.drawText("1", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("2 PM") || time.equals("12PM")) {
                    canvas.drawText("2", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("3 PM") || time.equals("3PM")) {
                    canvas.drawText("3", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("4 PM") || time.equals("4PM")) {
                    canvas.drawText("4", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("5 PM") || time.equals("5PM")) {
                    canvas.drawText("5", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("6 PM") || time.equals("6PM")) {
                    canvas.drawText("6", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("7 PM") || time.equals("7PM")) {
                    canvas.drawText("7", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("8 PM") || time.equals("8PM")) {
                    canvas.drawText("8", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("9 PM") || time.equals("9PM")) {
                    canvas.drawText("9", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("10 PM") || time.equals("10PM")) {
                    canvas.drawText("10", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
                if (time.equals("11 PM") || time.equals("11PM")) {
                    canvas.drawText("11", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
                }
        }
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        Log.d(TAG, "drawHeaderRowAndEvents: TTTOOOOOOODDDDAYYYYYYY "+today);
        Log.d(TAG, "drawHeaderRowAndEvents: CCCCCCCCAAAAAANNNNNVVVVVAAA "+canvas);
        ...
        Log.d(TAG, "drawHeaderRowAndEvents: CCCCCCCCCAAALENDAR 111111111111111 "+day);
        day.add(Calendar.HOUR, 6);
        Log.d(TAG, "drawHeaderRowAndEvents: CCCCCCCCCAAALENDAR "+day);
...
//       float bottom = mHeaderHeight + mHeaderRowPadding * 3;
        ...
        for (int dayNumber = leftDaysWithGaps + 1; dayNumber <= leftDaysWithGaps + mNumberOfVisibleDays + 1; dayNumber++) {
            ...
            String dayLabel2 = getDateTimeInterpreter().interpretday(day);
            Log.d(TAG, "drawHeaderRowAndEvents: LAAAAAAAAAAABEL "+dayLabel);
            Log.d(TAG, "drawHeaderRowAndEvents: LAAAAAAAAAAABEL111111111111 "+dayLabel1);
            if (dayLabel == null)
            ...
            if (mNumberOfVisibleDays == 1) {
                ...
                if (dayLabel.contains("MON")) {
                    canvas.drawText("Kerĩ", startPixel - mHeaderColumnWidth / 2.0f, mHeaderTextHeight + mHeaderRowPadding / 3.0f, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
                } else if (dayLabel.contains("TUE")) {
                    canvas.drawText("Gatatũ", startPixel - mHeaderColumnWidth / 2.0f, mHeaderTextHeight + mHeaderRowPadding / 3.0f, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
                } else if (dayLabel.contains("WED")) {
                    canvas.drawText("Kana", startPixel - mHeaderColumnWidth / 2.0f, mHeaderTextHeight + mHeaderRowPadding / 3.0f, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
                } else if (dayLabel.contains("THU")) {
                    canvas.drawText("Gatano", startPixel - mHeaderColumnWidth / 2.0f, mHeaderTextHeight + mHeaderRowPadding / 3.0f, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
                } else if (dayLabel.contains("FRI")) {
                    canvas.drawText("Gatandatũ", startPixel - mHeaderColumnWidth / 2.0f, mHeaderTextHeight + mHeaderRowPadding / 3.0f, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
                } else if (dayLabel.contains("SAT")) {
                    canvas.drawText("Mũtua Rũru", startPixel - mHeaderColumnWidth / 2.0f, mHeaderTextHeight + mHeaderRowPadding / 3.0f, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
                } else if (dayLabel.contains("SUN")) {
                    canvas.drawText("Kiumia", startPixel - mHeaderColumnWidth / 2.0f, mHeaderTextHeight + mHeaderRowPadding / 3.0f, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
                } else {
                ...
                if (sameDay) {
                    ...
                    if (dayLabel.contains("TUE")) {
                        dayLabel = "Gatatũ";
                        dayLabel2 = "Tuesday";
                    }
                    if (dayLabel.contains("WED")) {
                        dayLabel = "Kana";
                        dayLabel2 = "Wednesday";
                    }
                    if (dayLabel.contains("THU")) {
                        dayLabel = "Gatano";
                        dayLabel2 = "Thursday";
                    }
                    if (dayLabel.contains("FRI")) {
                        dayLabel = "Gatandatũ";
                        dayLabel2 = "Friday";
                    }
                    if (dayLabel.contains("SAT")) {
                        dayLabel = "Mũtua Rũru";
                        dayLabel2 = "Saturday";
                    }
                    if (dayLabel.contains("SUN")) {
                        dayLabel = "Kiumia";
                        dayLabel2 = "Sunday";
                    }

                canvas.drawText(dayLabel, startPixel + mWidthPerDay / 2, mHeaderTextHeight + mHeaderRowPadding / 2.9f, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
                canvas.drawText(dayLabel1, startPixel + mWidthPerDay / 2, mHeaderTextHeight + mHeaderRowPadding * 1.70f + jHeaderTextHeight, sameDay ? jtodayHeaderTextPaint : jHeaderTextPaint);
               // canvas.drawText(dayLabel2, startPixel + mWidthPerDay / 2, mHeaderTextHeight + mHeaderRowPadding * 5.5f, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
                canvas.drawText(dayLabel2, startPixel + mWidthPerDay / 2, mHeaderTextHeight + mHeaderRowPadding * 3.9f + jHeaderTextHeight, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
//canvas.drawText(dayLabel2, startPixel + mWidthPerDay / 2, mHeaderTextHeight + mHeaderRowPadding * 1.76f + jHeaderTextHeight, sameDay ? jtodayHeaderTextPaint : jHeaderTextPaint);
    ...
    private Calendar getTimeFromPoint(float x, float y) {
        ...
        for (int dayNumber = leftDaysWithGaps + 1;
            ...
            if (mWidthPerDay + startPixel - start > 0 && x > start && x < startPixel + mWidthPerDay) {
                ...
                Log.d(TAG, "getTimeFromPoint: MY CHEOO "+day);
                return day;
            }
            startPixel += mWidthPerDay + mColumnGap;
        }
                ...
                if (isSameDay(mEventRects.get(i).event.getStartTime(), date) && mEventRects.get(i).event.isAllDay()) {
                    ...
                    if (left < right &&
                        ...
                        if (mycheck){
                            ...
                            Log.d(TAG, "drawAllDayEvents: ONEEE "+ mEventRects.get(i).event.getName());
                            Log.d(TAG, "drawAllDayEvents: TWOO "+ mEventRects.get(i).rectF.left);
                            Log.d(TAG, "drawAllDayEvents: THREE "+ mEventRects.get(i).rectF.left + 12);
                            Log.d(TAG, "drawAllDayEvents: FOURR "+ mEventRects.get(i).rectF.centerY() +" - "+ jheaderEventheight);
                            Log.d(TAG, "drawAllDayEvents: FIVEE "+ mEventRects.get(i).rectF.centerY());
                            Log.d(TAG, "drawAllDayEvents: SIXX "+ jheaderEventheight);
                            Log.d(TAG, "drawAllDayEvents: SEVENN "+ jheaderEventTextpaint);
                        }
                    } else
                        mEventRects.get(i).rectF = null;
                }
            ...
            mDateTimeInterpreter = new DateTimeInterpreter() {
                ...
                public String interpretday(Calendar date) {
                    try {
                        ...
                        Log.d(TAG, "interpretday: IIINNNNTERPRATE "+ String.format("%s %s", sdf.format(date.getTime()).toUpperCase(), localizedDate));
...
//        }
    ...
    public void goToDate(Calendar date) {
        ...
        Log.d(TAG, "goToDate: FFFFFIIII "+day+ " AND1 "+dateInMillis+" AND2 "+todayInMillis+" AND3 "+dateDifference+" AND LAST "+ mCurrentOrigin);
        invalidate();
    }
